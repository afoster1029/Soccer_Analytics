...
#### Data Wrangling
* We created a dataframe where each game in the original dataset is represent in two rows. One row for each team. 
...
MLS_final[1:2, "OpAGC"] = 0
MLS_final[1:2, "Position"] = 0
MLS_final[1:2, "OpPosition"] = 0
MLS_final[409:410, "OpAGC"] = 0
MLS_final[409:410, "Position"] = 0
MLS_final[409:410, "OpPosition"] = 0
